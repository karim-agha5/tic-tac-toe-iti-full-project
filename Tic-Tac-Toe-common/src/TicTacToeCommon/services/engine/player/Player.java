package TicTacToeCommon.services.engine.player;
...
public abstract class Player {
    ...
    public final String toString() {
        return this.getLeague().toString();
    }
    ...
    public static final class CrossPlayer extends Player {
        ...
        public CrossPlayer(final Board board) {
            super(board);
        }

        @Override
        public Player getOpponent() {
            return super.getBoard().getNoughtPlayer();
        }
    ...
    public static final class NoughtPlayer extends Player {
        ...
        public NoughtPlayer(final Board board) {
            super(board);
        }
